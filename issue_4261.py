...
if __name__ == "__main__":
    ...
    n_clusters = 2
    known_clusters = SpectralClustering(affinity="nearest_neighbors", n_clusters=n_clusters, random_state=0,
                                        assign_labels="discretize")

    G = spectral_clustering_to_graph(known_clusters, n_clusters)

    # toy example for graph_to_spectral_clustering
    derived_clusters = SpectralClustering(affinity='precomputed',
                                          assign_labels="discretize",
                                          random_state=0,
