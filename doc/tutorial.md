...
floating point arithmetic.  This is especially true for algorithms such as shortest-path,
flows, cuts, minimum-spanning, etc. Basically any time a min or max value is computed.
