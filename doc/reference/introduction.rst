...
The basic graph classes are :class:`~networkx.Graph`,
...
Graph generators such as :func:`~networkx.generators.binomial_graph` and
:func:`~networkx.generators.powerlaw_graph` are provided in the
:mod:`~networkx.generators` subpackage.
...
documentation under the term :mod:`~networkx.algorithms`.
...
(see :mod:`~networkx.algorithms.traversal`),
...
The drawing tools are provided in the module :mod:`~networkx.drawing`.
