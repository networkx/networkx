...
def set_warnings():
    ...
    warnings.filterwarnings("ignore", category=DeprecationWarning, message="project")
    warnings.filterwarnings("ignore", category=DeprecationWarning, message="find_cores")
