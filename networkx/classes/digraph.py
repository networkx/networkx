...
class DiGraph(Graph):
    ...
    **Reporting:**
    ...
    def subgraphview(self, nbunch):
        """Return a DiGraphView object which is essentially a read-only
        ...
        [(0, 1), (1, 2)]
        """
        return DiGraphView(self, nbunch)
...
class DiGraphView(DiGraph):
    ...
    def add_node(self, n, attr_dict=None, **attr):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support changing the graph')
    def add_nodes_from(self, nodes, **attr):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support changing the graph')
    def remove_node(self,n):
    ...
    def copy(self):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support copy()')
    def to_directed(self):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support to_directed()')
    def to_undirected(self):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support to_directed()')
    def subgraph(self, nbunch):
        """This method is not supported for DiGraphView"""
        raise NetworkXError('DiGraphView class does not support subgraph()')
