...
class BaseMultiDiGraphTester(BaseMultiGraphTester):
    def test_edges(self):
        ...
        pytest.raises((KeyError, nx.Error), G.edges, -1)
    ...
    def test_edges_data(self):
        ...
        pytest.raises((KeyError, nx.Error), G.neighbors, -1)
    ...
    def test_out_edges(self):
        ...
        pytest.raises((KeyError, nx.Error), G.out_edges, -1)
    ...
    def test_in_edges(self):
        ...
        pytest.raises((KeyError, nx.Error), G.in_edges, -1)
        G.add_edge(0, 1, 2)
    ...
    def test_successors(self):
        ...
        pytest.raises((KeyError, nx.Error), G.successors, -1)
    ...
    def test_predecessors(self):
        ...
        pytest.raises((KeyError, nx.Error), G.predecessors, -1)
    ...
    def test_reverse_nocopy(self):
        ...
        assert sorted(R.edges()) == [(1, 0), (1, 0)]
        pytest.raises(nx.Error, R.remove_edge, 1, 0)
...
class TestMultiDiGraph(BaseMultiDiGraphTester, _TestMultiGraph):
    ...
    def test_add_edges_from(self):
        ...
        # too few in tuple
        pytest.raises(nx.Error, G.add_edges_from, [(0,)])
        # too many in tuple
        pytest.raises(nx.Error, G.add_edges_from, [(0, 1, 2, 3, 4)])
        # not a tuple
    ...
    def test_remove_edge(self):
        ...
        pytest.raises((KeyError, nx.Error), G.remove_edge, -1, 0)
        pytest.raises((KeyError, nx.Error), G.remove_edge, 0, 2, key=1)
