...
class BaseDiGraphTester(BaseGraphTester):
    ...
    def test_successors_iter(self):
        ...
        assert_raises(
            (KeyError, networkx.NetworkXError), G.successors_iter, -1)
    ...
    def test_predecessors_iter(self):
        ...
        assert_raises(
            (KeyError, networkx.NetworkXError), G.predecessors_iter, -1)
...
class TestDiGraph(BaseAttrDiGraphTester, TestGraph):
    ...
    def setUp(self):
        ...
        self.k3adj = {
            0: {1: ed1, 2: ed2}, 1: {0: ed3, 2: ed4}, 2: {0: ed5, 1: ed6}}
        self.k3edges = [(0, 1), (0, 2), (1, 2)]
        self.k3nodes = [0, 1, 2]
        self.K3 = self.Graph()
        self.K3.adj = self.K3.succ = self.K3.edge = self.k3adj
        self.K3.pred = {
            0: {1: ed3, 2: ed5}, 1: {0: ed1, 2: ed6}, 2: {0: ed2, 1: ed4}}
    ...
    def test_add_edges_from(self):
        ...
        assert_equal(
            G.adj, {0: {1: {'data': 2}, 2: {'data': 3}}, 1: {}, 2: {}})
        assert_equal(
            G.succ, {0: {1: {'data': 2}, 2: {'data': 3}}, 1: {}, 2: {}})
        assert_equal(G.pred, {0: {}, 1: {0: {'data': 2}}, 2: {0: {'data': 3}}})

        assert_raises(
            networkx.NetworkXError, G.add_edges_from, [
                (0,)])  # too few in tuple
        assert_raises(
            networkx.NetworkXError, G.add_edges_from, [
                (0, 1, 2, 3)])  # too many in tuple
    ...
    def test_remove_edge(self):
        ...
        G.remove_edge(0, 1)
        assert_equal(
            G.succ, {0: {2: {}}, 1: {0: {}, 2: {}}, 2: {0: {}, 1: {}}})
        assert_equal(
            G.pred, {0: {1: {}, 2: {}}, 1: {2: {}}, 2: {0: {}, 1: {}}})
