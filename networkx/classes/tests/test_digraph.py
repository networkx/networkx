...
class BaseDiGraphTester(BaseGraphTester):
    ...
    def test_degree(self):
        ...
        assert_equal(sorted(G.degree(iter([0]))), [(0, 4)]) #run through iterator
    ...
    def test_in_degree(self):
        ...
        assert_equal(sorted(G.in_degree(iter([0]))), [(0, 2)]) #run through iterator
    ...
    def test_in_degree_weighted(self):
        ...
        assert_equal(sorted(G.in_degree(iter([1]),weight='other')), [(1, 2.2)])
    ...
    def test_out_degree_weighted(self):
        ...
        assert_equal(sorted(G.out_degree(iter([0]), weight='other')), [(0, 2.2)])
    ...
    def test_out_degree(self):
        ...
        assert_equal(sorted(G.out_degree(iter([0]))), [(0, 2)])
