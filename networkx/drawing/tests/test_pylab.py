...
class TestPylab:
    ...
    def test_draw_empty_nodes_return_values(self):
        ...
        assert isinstance(nx.draw_networkx_edges(G, pos, edgelist=[], arrows=True), LineCollection)
        assert isinstance(nx.draw_networkx_edges(G, pos, edgelist=[], arrows=False), LineCollection)
        assert isinstance(nx.draw_networkx_edges(DG, pos, edgelist=[], arrows=False), LineCollection)
