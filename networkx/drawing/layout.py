...
def random_layout(G, dim=2, scale=1.0, center=None):
...
def circular_layout(G, dim=2, scale=1.0, center=None):
    # dim=2 only
...
def shell_layout(G, dim=2, scale=1.0, center=None, nlist=None):
...
def fruchterman_reingold_layout(G, dim=2, scale=1.0, center=None,
                                weight='weight', k=None, pos=None,
                                fixed=None, iterations=50):
...
def spectral_layout(G, dim=2, scale=1.0, center=None, weight='weight'):
