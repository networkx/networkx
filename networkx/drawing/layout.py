...
@np_random_state(3)
def random_layout(G, center=None, dim=2, seed=None, attribute=None):
...
def circular_layout(G, scale=1, center=None, dim=2, attribute=None):
    # dim=2 only
...
def shell_layout(
    G, nlist=None, rotate=None, scale=1, center=None, dim=2, attribute=None
):
    ...
    if attribute is not None:
        nx.set_node_attributes(G, npos, attribute)
    return npos


def bipartite_layout(
    G, nodes, align="vertical", scale=1, center=None, aspect_ratio=4 / 3, attribute=None
):
...
def kamada_kawai_layout(
    G, dist=None, pos=None, weight="weight", scale=1, center=None, dim=2, attribute=None
):
...
def spectral_layout(G, weight="weight", scale=1, center=None, dim=2, attribute=None):
...
def planar_layout(G, scale=1, center=None, dim=2, attribute=None):
...
def spiral_layout(
    G, scale=1, center=None, dim=2, resolution=0.35, equidistant=False, attribute=None
):
...
def multipartite_layout(
    G, subset_key="subset", align="vertical", scale=1, center=None, attribute=None
):
...
def bfs_layout(G, start, *, align="vertical", scale=1, center=None, attribute=None):
