...
def generate_unique_node():
    ...
    --------
    >>> G = nx.Graph()
    >>> G.add_nodes_from([generate_unique_node() for _ in range(3)])
    >>> for n in G.nodes():  # doctest: +SKIP
    ...     print(n)
    909d8331-db27-44de-a0a6-ed3ffa46076e
    290ef006-c2a8-46da-9a96-f242bf4c71b4
    0a59d0ae-9699-4a7f-a5cb-b009f634cf7b

    Notes
    -----
    Uniqueness is only guaranteed amongst nodes that are generated by this
    function.
