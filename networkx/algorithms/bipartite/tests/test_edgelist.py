...
class TestEdgelist:
    ...
    def setUp(self):
        ...
        self.G.add_nodes_from(['a','c','e'],part=0)
        self.G.add_nodes_from(['b','d','f'],part=1)
        self.G.add_node('g',part=0)
        self.DG=nx.DiGraph(self.G)
        self.MG=nx.MultiGraph()
        self.MG.add_edges_from([(1,2),(1,2),(1,2)])
        self.MG.add_node(1,part=0)
        self.MG.add_node(2,part=1)
...
"""
    ...
    def test_unicode(self):
        ...
        G.add_node(name1,part=0)
        G.add_node('Radiohead',part=1)
