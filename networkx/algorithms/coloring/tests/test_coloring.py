...
class TestColoring:
    ...
    def test_case_V_plus_not_in_A_cal(self):
        ...
        L = {0: [2, 5], 1: [3, 4], 2: [0, 8], 3: [1, 7], 4: [1, 6],
             5: [0, 6], 6: [4, 5], 7: [3], 8: [2]}
        F = {
            # Color 0
            0: 0, 1: 0,
    ...
    def test_cast_no_solo(self):
        L = {0: [8, 9], 1: [10, 11], 2: [8], 3: [9], 4: [10, 11],
            5: [8], 6: [9], 7: [10, 11], 8: [0, 2, 5],
            9: [0, 3, 6], 10: [1, 4, 7], 11: [1, 4, 7]}
    ...
    def test_hard_prob(self):
        ...
        G = nx.Graph()
        G.add_edges_from(
            [(0, 10), (0, 11), (0, 12), (0, 23), (10, 4), (10, 9), (10, 20),
             (11, 4), (11, 8), (11, 16), (12, 9), (12, 22), (12, 23), (23, 7),
             (1, 17), (1, 18), (1, 19), (1, 24), (17, 5), (17, 13), (17, 22),
             (18, 5), (19, 5), (19, 6), (19, 8), (24, 7), (24, 16), (2, 4),
             (2, 13), (2, 14), (2, 15), (4, 6), (13, 5), (13, 21), (14, 6),
             (14, 15), (15, 6), (15, 21), (3, 16), (3, 20), (3, 21), (3, 22),
             (16, 8), (20, 8), (21, 9), (22, 7)]
        )
    ...
    for node in graph.nodes():
        ...
        for neighbor in graph.neighbors(node):
            if coloring[neighbor] == color:
                return False
    colset = {col for col in coloring.values()}
...
def G5():
    ...
    graph.add_nodes_from([1, 2, 3, 4, 5, 6, 7])
    graph.add_edges_from(
        [(1, 7), (1, 6), (1, 3), (1, 4), (7, 2), (2, 6), (2, 3), (2, 5),(5, 3), (5, 4), (4, 3)]
    )
    return graph
...
def G7():
    ...
    graph.add_nodes_from([1, 2, 3, 4, 5, 6, 7, 8])
    graph.add_edges_from(
        [(1, 2), (1, 3), (1, 5), (1, 7), (2, 3), (2, 4), (2, 8), (8, 4),
         (8, 6), (8, 7), (7, 5), (7, 6), (3, 4), (4, 6), (6, 5), (5, 3)]
    )
    return graph
...
def G13():
    ...
    graph.add_edges_from(
        [(1, 2), (1, 5), (1, 6), (1, 7), (2, 3), (2, 8), (2, 9), (3, 4), 
         (3, 8), (3, 9), (4, 5), (4, 6), (4, 7), (5, 6)]
    )
    return graph
...
def G14():
    ...
    graph.add_nodes_from([1, 2, 3, 4, 5, 6, 7])
    graph.add_edges_from(
        [(1, 2), (1, 3), (1, 5), (1, 7), (2, 3), (2, 6), (3, 4), (4, 5),
         (4, 6), (5, 7), (6, 7)]
    )
    return graph
...
def G15():
    ...
    graph.add_nodes_from([1, 2, 3, 4, 5, 6, 7, 8, 9])
    graph.add_edges_from(
        [(1, 2), (1, 3), (1, 4), (1, 5), (2, 3), (2, 7), (2, 8), (2, 9),
         (3, 6), (3, 7), (3, 9), (4, 5), (4, 6), (4, 8), (4, 9), (5, 6),
         (5, 7), (5, 8), (6, 7), (6, 9), (7, 8), (8, 9)]
    )
    return graph
...
# --------------------------------------------------------------------------
# Test graphs
TEST_CASES = [null_graph, singleton, dyad, 
              disconnected, three_node_clique, G1, G2, G3, G4, G5, 
              G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, big_empty,
              big_sparse, big_rand, big_dense, big_complete]
