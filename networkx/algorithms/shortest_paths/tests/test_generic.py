...
class TestGenericPath:
    ...
    def test_all_shortest_paths_zero_weight_edge(self):
        ...
        paths30d = list(nx.all_shortest_paths(g, 3, 0, weight='weight',
                                              method='dijkstra'))
        paths03d = list(nx.all_shortest_paths(g, 0, 3, weight='weight',
                                              method='dijkstra'))
        paths30b = list(nx.all_shortest_paths(g, 3, 0, weight='weight',
                                              method='bellman-ford'))
        paths03b = list(nx.all_shortest_paths(g, 0, 3, weight='weight',
                                              method='bellman-ford'))
