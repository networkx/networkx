...
# with the "mode" kwarg is equivalent to the corresponding function (i.e.
# nx.fast_could_be_isomorphic or nx.faster_could_be_isomorphic)
fast_cbi = partial(nx.could_be_isomorphic, mode="fast")
faster_cbi = partial(nx.could_be_isomorphic, mode="faster")
