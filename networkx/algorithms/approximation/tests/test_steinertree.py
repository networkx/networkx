...
class TestSteinerTree:
    ...
    def test_metric_closure(self):
        ...
        mc = [(1, 2, {'distance': 1, 'path': [1, 2]}),
              (1, 3, {'distance': 2, 'path': [1, 2, 3]}),
              (1, 4, {'distance': 2.2, 'path': [1, 2, 7, 5, 4]}),
              (1, 5, {'distance': 1.2000000000000002, 'path': [1, 2, 7, 5]}),
              (1, 6, {'distance': 2.2, 'path': [1, 2, 7, 5, 6]}),
              (1, 7, {'distance': 1.1, 'path': [1, 2, 7]}),
              (2, 3, {'distance': 1, 'path': [2, 3]}),
              (2, 4, {'distance': 1.2, 'path': [2, 7, 5, 4]}),
              (2, 5, {'distance': 0.2, 'path': [2, 7, 5]}),
              (2, 6, {'distance': 1.2, 'path': [2, 7, 5, 6]}),
              (2, 7, {'distance': 0.1, 'path': [2, 7]}),
              (3, 4, {'distance': 1, 'path': [3, 4]}),
              (3, 5, {'distance': 1.2000000000000002,
                      'path': [3, 2, 7, 5]}),
              (3, 6, {'distance': 2.2, 'path': [3, 2, 7, 5, 6]}),
              (3, 7, {'distance': 1.1, 'path': [3, 2, 7]}),
              (4, 5, {'distance': 1, 'path': [4, 5]}),
              (4, 6, {'distance': 2, 'path': [4, 5, 6]}),
              (4, 7, {'distance': 1.1, 'path': [4, 5, 7]}),
              (5, 6, {'distance': 1, 'path': [5, 6]}),
              (5, 7, {'distance': 0.1, 'path': [5, 7]}),
              (6, 7, {'distance': 1.1, 'path': [6, 5, 7]})]
