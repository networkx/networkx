...
class TestDivideGraphicalCake:
    def test_get_contiguous_oriented_labeling(self):
        ...
        assert dgc.get_contiguous_oriented_labeling(g1) == [(3, 1), (1, 2), (3, 2), (2, 4), (4, 5), (5, 6), (4, 6)], \
            {1: [1, -2], 2: [2, 3, -4],
            3: [-1, -3], 4: [4, -5, -6],
            5: [6, -7], 6: [5, 7]}
        assert dgc.get_contiguous_oriented_labeling(g2) == [(2, 5), (4, 5), (3, 4), (2, 3), (1, 2)], \
            {1: [5], 2: [-5, 3, -4], 3: [-3, 2], 4: [-2, 1], 5: [4, -1]}
        assert dgc.get_contiguous_oriented_labeling(g3) == [(1, 2), (2, 3), (3, 4), (4, 5), (2, 5), (5, 6)], {1: [-1],
                                                                                                             2: [1, -2,
                                                                                                                  -5],
                                                                                                              3: [2,
                                                                                                                  -3],
