...
import pytest
from Exchange_Algorithm import Maximum_weight_cycle_packing_approximation_algorithm, ExactAlgorithm
...
def test_4():
    ...
    assert ExactAlgorithm(graphEX3, 3) == [[1, 6], [11, 15], [16, 13, 12], [18, 19], [4, 5, 7], [8, 9]']
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 2) == ['[1, 6]', '[11, 15]', '[18, 19]', '[8, 9]']
    assert ExactAlgorithm(graphEX3, 3) == [[1, 6], [11, 15], [18, 19], [8, 9]]
