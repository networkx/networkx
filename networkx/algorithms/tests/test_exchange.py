...
import pytest
from networkx.algorithms.approximation.Maximum_weight_cycle_packing_approximation_algorithm import Maximum_weight_cycle_packing_approximation_algorithm
...
def test_1():
    ...
    graphEX3.add_weighted_edges_from(
        [(1, 2, 4), (2, 1, 3), (1, 3, 5), (3, 1, 6), (3, 2, 1), (2, 3, 2), (1, 5, 9), (1, 6, 8), (6, 1, 7), (4, 1, 11),
         (6, 4, 10), (5, 6, 12)])
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 3) == ['[1, 6, 4]', '[2, 3]']
    assert maximum_weight_cycle_packing(graphEX3, 3) == [[1,6,4]]
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 2) == ['[1, 6]', '[2, 3]']
...
def test_3():
    ...
    graphEX3.add_weighted_edges_from(
        [(1, 6, 11), (6, 1, 10), (1, 5, 3), (5, 1, 2), (8, 9, 11), (9, 8, 20), (3, 2, 6), (2, 6, 5), (6, 3, 8),
         (5, 7, 6), (7, 4, 11), (4, 5, 5)])
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 3) == ['[1, 6]', '[4, 5, 7]', '[8, 9]']
...
def test_4():
    ...
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 3) == ['[1, 6]', '[11, 15]', '[16, 13, 12]', '[18, 19]', '[4, 5, 7]', '[8, 9]']
    assert maximum_weight_cycle_packing(graphEX3, 3) == [[1, 6], [11, 15], [16, 13, 12], [18, 19], [4, 5, 7], [8, 9]]
    assert Maximum_weight_cycle_packing_approximation_algorithm(graphEX3, 2) == ['[1, 6]', '[11, 15]', '[18, 19]', '[8, 9]']
    assert maximum_weight_cycle_packing(graphEX3, 3) == [[1, 6], [11, 15], [18, 19], [8, 9]]
