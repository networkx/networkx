...
class TestTreeLCA:
    ...
    def test_tree_all_pairs_lowest_common_ancestor1(self):
        ...
        assert_equal(dict(nx.tree_all_pairs_lowest_common_ancestor(self.DG)),
                     self.ans)
    ...
    def test_tree_all_pairs_lowest_common_ancestor2(self):
        ...
        ans = dict(nx.tree_all_pairs_lowest_common_ancestor(self.DG, 0, test_pairs))
    ...
    def test_tree_all_pairs_lowest_common_ancestor5(self):
        ...
        bad_pairs_digraph = nx.tree_all_pairs_lowest_common_ancestor(self.DG, pairs=[(-1, -2)])
    ...
    def test_tree_all_pairs_lowest_common_ancestor9(self):
        ...
        some_pairs = dict(nx.tree_all_pairs_lowest_common_ancestor(self.DG, 0, pairs))
