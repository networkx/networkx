...
class TestDAG:
    ...
    def test_transitive_closure(self):
        ...
        assert edges_equal(nx.transitive_closure(G).edges(), res)
        ...
        res = [(1, 2), (2, 1), (2, 3), (3, 2), (1, 3), (3, 1)]
        res = sorted(res + [(n, n) for n in G])
        assert edges_equal(sorted(nx.transitive_closure(G).edges()), res)
