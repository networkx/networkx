...
class TestTreeLCA:
    ...
    def setUp(self):
        ...
        self.ans = dict(tree_all_pairs_lowest_common_ancestor(self.DG, 0))
    ...
    def test_tree_all_pairs_lowest_common_ancestor1(self):
        ...
        assert_equal(dict(tree_all_pairs_lowest_common_ancestor(self.DG)),
                     self.ans)
    ...
    def test_tree_all_pairs_lowest_common_ancestor2(self):
        ...
        ans = dict(tree_all_pairs_lowest_common_ancestor(self.DG, 0, test_pairs))
    ...
    def test_tree_all_pairs_lowest_common_ancestor3(self):
        ...
        ans = dict(tree_all_pairs_lowest_common_ancestor(self.DG, 0, all_pairs))
        self.assert_has_same_pairs(ans, self.ans)

    def test_tree_all_pairs_lowest_common_ancestor4(self):
        """Gives the right answer."""
        ans = dict(tree_all_pairs_lowest_common_ancestor(self.DG))
    ...
    def test_tree_all_pairs_lowest_common_ancestor6(self):
        """Works on subtrees."""
        ans = dict(tree_all_pairs_lowest_common_ancestor(self.DG, 1))
    ...
    def test_tree_all_pairs_lowest_common_ancestor7(self):
        ...
        G = nx.DiGraph()
        G.add_node(1)
        assert_equal({(1, 1): 1}, dict(tree_all_pairs_lowest_common_ancestor(G)))
    ...
    def test_tree_all_pairs_lowest_common_ancestor9(self):
        ...
        some_pairs = dict(tree_all_pairs_lowest_common_ancestor(self.DG, 0, pairs))
...
class TestDAGLCA:
    ...
    def test_all_pairs_lowest_common_ancestor2(self):
        ...
        ans = nx.all_pairs_lowest_common_ancestor(self.DG, pairs=all_pairs)
    ...
    def test_all_pairs_lowest_common_ancestor5(self):
        """Test that pairs not in the graph raises error."""
        assert_raises(nx.NetworkXError, nx.all_pairs_lowest_common_ancestor, self.DG, [(-1, -1)])
