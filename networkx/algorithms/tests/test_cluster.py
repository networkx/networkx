...
class TestWeightedClustering:
    ...
    def test_cubical(self):
        ...
        assert_equal(
            list(nx.clustering(G, [1, 2], weight='weight').values()), [0, 0])
    ...
    def test_k5(self):
        ...
        assert_equal(list(nx.clustering(G, weight='weight').values()),
                     [5. / 6., 1.0, 1.0, 5. / 6., 5. / 6.])
        assert_equal(
            nx.clustering(G, [1, 4], weight='weight'), {1: 1.0, 4: 0.83333333333333337})
...
class TestClustering:
    ...
    def test_k5(self):
        ...
        assert_equal(list(nx.clustering(G).values()),
                     [5. / 6., 1.0, 1.0, 5. / 6., 5. / 6.])
        assert_equal(
            nx.clustering(G, [1, 4]), {1: 1.0, 4: 0.83333333333333337})
...
class TestSquareClustering:
    ...
    def test_cubical(self):
        ...
        assert_equal(
            list(nx.square_clustering(G, [1, 2]).values()), [0.5, 0.5])
