...
class TestMaxWeightMatching(object):
    ...
    def test_trivial4(self):
        ...
        max_answer = matching_dict_to_set({'three': 'two', 'two': 'three'})
        assert_edges_equal(nx.max_weight_matching(G), max_answer)
        min_answer = matching_dict_to_set({'one': 'two', 'two': 'one'})
        assert_edges_equal(nx.min_weight_matching(G), min_answer)
    ...
    def test_trivial6(self):
        ...
        assert_edges_equal(nx.min_weight_matching(G, weight='abcd'),
    ...
    def test_s_blossom(self):
        ...
        ansdict = {1: 6, 2: 3, 3: 2, 4: 5, 5: 4, 6: 1}
    ...
    def test_nested_s_blossom_relabel(self):
        ...
        G.add_weighted_edges_from([(1, 2, 10), (1, 7, 10), (2, 3, 12),
                                   ...
                                   (5, 6, 10), (6, 7, 10), (7, 8, 8)])
        ansdict = {1: 2, 2: 1, 3: 4, 4: 3, 5: 6, 6: 5, 7: 8, 8: 7}
        answer = matching_dict_to_set(ansdict)
        assert_edges_equal(nx.max_weight_matching(G), answer)
        assert_edges_equal(nx.min_weight_matching(G), answer)
    ...
    def test_nested_s_blossom_expand(self):
        ...
        G.add_weighted_edges_from([(1, 2, 8), (1, 3, 8), (2, 3, 10),
                                   ...
                                   (7, 8, 12)])
        ansdict = {1: 2, 2: 1, 3: 5, 4: 6, 5: 3, 6: 4, 7: 8, 8: 7}
        answer = matching_dict_to_set(ansdict)
        assert_edges_equal(nx.max_weight_matching(G), answer)
        assert_edges_equal(nx.min_weight_matching(G), answer)
    ...
    def test_s_blossom_relabel_expand(self):
        ...
        G.add_weighted_edges_from([(1, 2, 23), (1, 5, 22), (1, 6, 15),
                                   ...
                                   (4, 8, 14), (5, 7, 13)])
        ansdict = {1: 6, 2: 3, 3: 2, 4: 8, 5: 7, 6: 1, 7: 5, 8: 4}
        answer = matching_dict_to_set(ansdict)
        assert_edges_equal(nx.max_weight_matching(G), answer)
        assert_edges_equal(nx.min_weight_matching(G), answer)
    ...
    def test_nested_s_blossom_relabel_expand(self):
        ...
        G.add_weighted_edges_from([(1, 2, 19), (1, 3, 20), (1, 8, 8),
                                   ...
                                   (4, 5, 13), (4, 7, 7), (5, 6, 7)])
        ansdict = {1: 8, 2: 3, 3: 2, 4: 7, 5: 6, 6: 5, 7: 4, 8: 1}
        answer = matching_dict_to_set(ansdict)
        assert_edges_equal(nx.max_weight_matching(G), answer)
        assert_edges_equal(nx.min_weight_matching(G), answer)
