...
def interval_graph(intervals):
    ...
    with a vertex for each interval and an edge between vertices whose intervals intersect.
    ...
    Parameters
    ----------
    intervals : a list of intervals, each element of which is a form of tuple ,say (l, r) where l,r is a left end,
    right end of an closed interval, respectively. Followings are invalid intervals.
