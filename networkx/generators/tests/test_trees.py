...
class TestPrefixTree:
    ...
    @pytest.mark.parametrize("prefix_tree_fn", (nx.prefix_tree, nx.prefix_tree_recursive))##, nx.prefix_tree_test))
    def test_basic_prefix_tree(self, prefix_tree_fn):
    ...
    def test_implementations_consistent(self, strings):
