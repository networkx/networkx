...
class Search(object):
    ...
    """
    def __init__(self, G, queue=networkx.queues.DFS):
...
class Preorder(Search):
    """ Preorder visitor     
        ...
        """
    def __init__(self, G, queue=networkx.queues.DFS, **kwds):
        self.forest=[]
...
class Length(Search):
    ...
    """
    def __init__(self, G, queue=networkx.queues.BFS, **kwds):
        self.length={}
